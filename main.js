	...
	cards: [
		{
			...
			deserve someone with a B-student attendance record. And, whether I win or loose, I'll keep showing up to meetings.`,
		},
		{
			id: "dialog-budget",
			...
			missing out on grant funding, loosing their rights to own pets, and are becoming increasingly cynical about their 'rights'. It's time to change that.`,
		},
		{
			id: "dialog-green",
			title: "Housing Availability",
			summary: `Let's build the first new units of public housing in Arlington in 50 years — and subsidize it with market-rate units, too.`,
...
Two and Korean War veterans were being shut out of living here. We built them an entire
neighborhoods' worth of places to live. It's our duty as a town to respond to our
present humanitarian and housing crisis with just as much construction. The current redevelopment
...
rates, we'll make the new developments less reliant on state funds to operate, less easy politically to ignore, and as a bonus we'll
